...
const Navbar = () => {
  return (
    <div className="w-full px-8 py-3 h-16 flex justify-between items-center gap-4 bg-white">
      <div className="w-[360px] flex justify-start items-center gap-4">
        <div className="w-[81px] h-[28px] overflow-hidden">
          <input
            type="text"
            className="w-full h-full text-ellipsis text-[#1A181E] font-medium text-[20px] leading-[28px] outline-none bg-inherit"
          />
        </div>
        ...
        <div className="flex gap-[6px] items-center">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_99814_6194)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <defs>
              <clipPath id="clip0_99814_6194">
                <rect width="14" height="14" fill="white" />
              </clipPath>
            </defs>
          </svg>

          <h1 className="text-[#4D4D4D] text-xs font-normal">How it works</h1>
        </div>
      </div>
      <div className="w-[400px] h-[40px] flex-nowrap px-4 py-[9px] flex justify-start items-center gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
          ...
          fill="none"
        >
          <g clip-path="url(#clip0_99814_6198)">
            <path
        ...
        <div className="flex-1 overflow-hidden flex items-center ">
          <input
            className="w-full bg-inherit text-ellipsis outline-none text-[#808080] font-normal text-[15px] leading-[22px]"
            placeholder="Search features, tutorials, etc."
          />
        </div>
      </div>
      <div className="h-[40px] flex gap-4 items-center justify-center">
        <div className="w-[40px] h-[40px] rounded-[20px] flex-shrink-0 bg-[#E6E6E6] flex items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        <div className="w-[40px] h-[40px] rounded-[20px] flex-shrink-0 bg-[#E6E6E6] flex items-center justify-center">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_99814_6209)">
