...
const SearchBar = () => {
  return (
    <div className="flex justify-between mb-3">
      <div className="w-[248px] h-[40px] py-[10px] px-4 flex gap-2 border border-[#D9D9D9] rounded-[4px] bg-white items-center">
        <svg
          ...
          fill="none"
        >
          <g clip-path="url(#clip0_99814_21800)">
            <path
      ...
      <div className="flex gap-4">
        <div className="py-[6px] px-4 flex justify-center items-center gap-[6px] rounded-[4px] border border-[#D9D9D9] bg-white cursor-pointer">
          <h1 className="text-[#4D4D4D] font-normal text-base">Sort</h1>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
