...
const GenCard = ({ amt = 0, orders = 13 }) => {
  return (
    <Wrapper>
      <div className="flex items-center">
        <h1 className="text-[#4D4D4D] font-normal text-base mr-2">
          Amount Pending
        </h1>
        <svg
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-[#1A181E] font-medium text-[32px] leading-[38px]">
          &#8377; {amt}{" "}
        </h1>

        <div className="flex">
          <h1 className="text-[#146EB4] font-medium text-base underline">
            {orders} orders
          </h1>
          <svg
            xmlns="http://www.w3.org/2000/svg"
