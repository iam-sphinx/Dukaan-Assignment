...
const Credit = ({ creditleft = 0 }) => {
  return (
    <div className="w-[192px] h-[54px] px-3 py-[6px] bg-[#353C53] rounded-[4px] flex items-center gap-3">
      <div className="h-9 w-9 flex justify-center items-center rounded-[4px] p-[6px] bg-[#FFFFFF1A]">
        <svg
      ...
      <div>
        <h1 className="text-[white] font-normal text-[13px] leading-[16px] mb-[2px]">Available credits</h1>
        <h1 className="text-[white] font-medium text-base">{creditleft}</h1>
      </div>
    </div>
  );
};
